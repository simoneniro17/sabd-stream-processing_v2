...
public class StreamingJob {
    private static final boolean ENABLE_PROFILING = false;       // TRUE per abilitare metriche personalizzate
    ...
    private static final int PARALLELISM = 2;   // Parallelismo per le operazioni di Flink
